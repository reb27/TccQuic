...
plt.scatter(plot_x[0], plot_y[0], s=10, label='high priority')
plt.scatter(plot_x[1], plot_y[1], s=10, label='medium priority')
plt.scatter(plot_x[2], plot_y[2], s=10, label='low priority')
plt.legend()
